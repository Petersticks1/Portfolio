        ...
        <div className="w-[100%] ">
            <main className="pt-20 ">
                <div className="flex flex-col items-center justify-between md:flex-row ">
                    <div className="items-center content-center justify-center text-center md:text-left p-14">
                        <h3 className="justify-center my-8 text-2xl font-bold text-black md:text-5xl">
                            Hi, I am
                        </h3>
                        <h1 className="my-4 text-5xl font-bold text-black md:text-7xl">Adebayo Peter</h1>
                    ...
                    {/* Image Carousel */}
                    <div className="w-full p-10 bg-black md:w-2/4">
                        <Slider {...settings}>
                            <div className="">
                                <img
                                    src="/My-picture.png"
