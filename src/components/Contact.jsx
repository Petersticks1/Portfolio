  ...
  return (
    <div className="flex flex-col items-center px-8 my-20" id="contact">
      ...
      <div className="flex flex-col items-center justify-center py-10 bg-black md:py-20 md:flex-row md:gap-28 md:px-28 rounded-xl">
        ...
        //  animate="show"
        whileInView={"show"}
        viewport={{ once: true, amount: 0.7 }} className="text-3xl font-bold text-white md:text-6xl">
        ...
        //  animate="show"
        whileInView={"show"}
        viewport={{ once: true, amount: 0.7 }} className="text-[#d7d7d7] md:text-lg">
        ...
        //  animate="show"
        whileInView={"show"}
        viewport={{ once: true, amount: 0.7 }} className="items-center md:ml-20">
          <a
