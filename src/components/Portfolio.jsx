      ...
      <div className="px-8 mt-10 ">
        ...
        <div className="flex flex-wrap justify-center gap-4 my-8 w-full">
          <button
            ...
            className={`px-6 py-2 font-bold transition-all border-2 border-black rounded-lg ${activeTab === "all" ? "bg-black text-white" : "bg-white text-black hover:bg-gray-200"
              }`}
          >
            All Projects
          </button>
          <button
            ...
            className={`px-6 py-2 font-bold transition-all border-2 border-black rounded-lg ${activeTab === "web" ? "bg-black text-white" : "bg-white text-black hover:bg-gray-200"
              }`}
          >
            Web Projects
          </button>
          <button
            ...
            className={`px-6 py-2 font-bold transition-all border-2 border-black rounded-lg ${activeTab === "mobile" ? "bg-black text-white" : "bg-white text-black hover:bg-gray-200"
              }`}
          >
            Mobile Projects
          </button>
          ...
          {(activeTab === "mobile" || activeTab === "all") && (
            <>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-4 my-8 w-full">
                  <a
                    href="https://play.google.com/store/apps/details?id=com.shelf21mobile&pcampaignid=web_share"
                    className="p-2 sm:p-4 flex justify-center w-full bg-[#a2a0a0] hover:bg-[#615f5f] rounded-lg"
                  >
                    <button className="">
                      <span className="flex justify-center gap-1 sm:gap-2 items-center text-xs sm:text-base font-bold">
                        {" "}
                        ANDROID{" "}
                        <Icon icon="logos:google-play-icon" className="w-5 h-5 sm:w-8 sm:h-8" />
                  ...
                  >
                    <span className="flex justify-center gap-1 sm:gap-2 items-center text-xs sm:text-base font-bold">
                      {" "}
                      IOS{" "}
                      <Icon icon="mdi:apple" className="w-5 h-5 sm:w-8 sm:h-8" />
                      <ArrowUpRight className="w-4 h-4 sm:w-6 sm:h-6" />
                    </span>
                  </button>
                </div>
              ...
              <motion.div
                ...
                className="bg-black text-white justify-center  p-8 md:text-justify hover:bg-[#2b2626] rounded-xl"
              >
                <h1 className="text-2xl font-semibold ">Fittingz Mobile App</h1>
                <p className="font-thin">
                  Fittingz mobile application is a comprehensive platform designed for fashion designers and tailors to manage client records, track measurements, and organize incoming orders effortlessly.
                </p>

                <div className="grid grid-cols-2 gap-2 sm:gap-4 my-8 w-full">
                  <a
                    href="https://play.google.com/store/apps/details?id=com.psticks.fittingz&pcampaignid=web_share"
                    className="p-2 sm:p-4 flex justify-center w-full bg-[#a2a0a0] hover:bg-[#615f5f] rounded-lg"
                  >
                    <button className="">
                      <span className="flex justify-center gap-1 sm:gap-2 items-center text-xs sm:text-base font-bold">
                  ...
                  <a
                    href="https://apps.apple.com/ng/app/fittingz/id6764613198"
                    className="p-2 sm:p-4 flex justify-center w-full bg-[#a2a0a0] hover:bg-[#615f5f] rounded-lg"
                  >
                    <button className="">
                      <span className="flex justify-center gap-1 sm:gap-2 items-center text-xs sm:text-base font-bold">
              ...
              <motion.div
                ...
                className="bg-black text-white justify-center  p-8 md:text-justify hover:bg-[#2b2626] rounded-xl"
              >
                <h1 className="text-2xl font-semibold ">Slotfinance Mobile App</h1>
                <p className="font-thin">
                  Slotfinance mobile application is a digital money club for trusted friends. It’s a modern twist on the traditional Ajo system, allowing you and your friends to save, rotate funds, and receive payouts on your own terms.
                </p>

                <div className="grid grid-cols-2 gap-2 sm:gap-4 my-8 w-full">
                  <a
                    href="https://play.google.com/store/apps/details?id=com.slotmobile&pcampaignid=web_share"
                    className="p-2 sm:p-4 flex justify-center w-full bg-[#a2a0a0] hover:bg-[#615f5f] rounded-lg"
                  >
                    <button className="">
                      <span className="flex justify-center gap-1 sm:gap-2 items-center text-xs sm:text-base font-bold">
